...
<Project DefaultTargets="Build" ToolsVersion="14.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    <ProjectGuid>{4F4A7940-5663-0529-65DB-966EA475854A}</ProjectGuid>
  ...
  <ItemGroup>
    <CustomBuild Include="$(OutDir)\bcrypt_lib.node">
      ...
      <Command>call mkdir &quot;G:\nodejsproject\NodejsAuthentication\Authenticate\node_modules\bcrypt\lib\binding\napi-v3&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;$(OutDir)bcrypt_lib.node&quot; &quot;G:\nodejsproject\NodejsAuthentication\Authenticate\node_modules\bcrypt\lib\binding\napi-v3\bcrypt_lib.node&quot;&#xD;&#xA;if %errorlevel% neq 0 exit /b %errorlevel%</Command>
      <Message>Copying $(OutDir)/bcrypt_lib.node to G:\nodejsproject\NodejsAuthentication\Authenticate\node_modules\bcrypt\lib\binding\napi-v3</Message>
      <Outputs>G:\nodejsproject\NodejsAuthentication\Authenticate\node_modules\bcrypt\lib\binding\napi-v3\bcrypt_lib.node</Outputs>
    </CustomBuild>
  </ItemGroup>
  <ItemGroup>
    <ProjectReference Include="bcrypt_lib.vcxproj">
      <Project>{0BDC1659-7195-8CFB-F131-55EDB3DD11A6}</Project>
